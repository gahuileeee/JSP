		...
		mod.forEach((item)=>{
			...
			const textarea = this.parentElement.previousElementSibling;
			  ...
			  textarea.focus();
					...
					//this.closest('form'); 상위 node 중 가까운 form tag를 찾는 것
					form.submit();
...
<main>
    <section class="view">
        ...
        <table>
            ...
            <% if(Integer.parseInt(article.getFile()) > 0){ %>
            <tr>
                <td>첨부파일</td>
                <td>
        ...
        <div>
            ...
            <a href="/jboard1/list.jsp?<%=params.toString()%>" class="btnList">목록</a>
        </div>  
        ...
        <section class="commentForm">
            <h3>댓글쓰기</h3>
            <form action="/jboard1/proc/commentInsertProc.jsp" name="frmComment" method="post">
            	<input type="hidden" name="parent" value="<%= no %>">
